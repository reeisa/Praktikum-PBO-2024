...
public class TalentData implements EditInterface {
    ...
    // tambah data artist
    public void addArtistData() throws NumberFormatException, IOException {
        System.out.println("=========================================");
    ...
    // cek int
    public static int cekInt() throws IOException {
        int cek = 0;
        while (true) {
            try {
