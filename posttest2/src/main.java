...
public class main {
    ...
    static void viewData() throws IOException {
        ...
        if (dataTalent.isEmpty()) {
            ...
            for (Talent tl : dataTalent) {
                ...
                System.out.println("Age         : " + tl.getAge());
                System.out.println("Gender      : " + tl.getGender());
                System.out.println("Nationality : " + tl.getNationality());
    ...
    static Talent search(String name) {
        for (Talent tl : dataTalent) {
            if (tl.getName().equalsIgnoreCase(name)) {
                return tl;
            }
        }
        return null;
